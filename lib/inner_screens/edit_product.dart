...
import "../widgets/loading_manager/loading_manager.dart";
...
class _EditProductScreenState extends State<EditProductScreen> {
  ...
  // Update product
  void _updateForm(BuildContext context) async {
      ...
      try {
        ...
        if (_pickedImage != null) {
          ...
          if (kIsWeb) {
            ...
            await ref.putFile(_pickImage as File);
          }
        ...
        if (context.mounted) {
          GlobalMethods.errorDialog(
              subtitle: "Has occured when updating product: ${error.message}",
              context: context);
        }
      } catch (error) {
        setState(() {
        ...
        if (context.mounted) {
          GlobalMethods.errorDialog(
              subtitle: "Has occured when updating product: $error",
              context: context);
        }
      } finally {
        setState(() {
...
/*    var inputDecoration1 = InputDecoration(
      filled: true,
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        TextWidget(text: "Kg", color: color,textSize: 25,),
                                        Radio(
                                          value: 1,
                                          groupValue: val,
                                          onChanged: (value) {
                                        ...
                                        TextWidget(text: "Piece", color: color, textSize: 25,),
                                        Radio(
                                          value: 2,
                                          groupValue: val,
                                          onChanged: (value) {
